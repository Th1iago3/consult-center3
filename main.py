...
def cpf2():
    ...
    try:
        # API Call for CPF lookup
        url = f"http://api.bygrower.online/core/?token=gustta&base=cpf1&query={cpf}"
        response = requests.get(url, verify=False)  # Note: verify=False to disable SSL verification, use with caution!
        response.raise_for_status()  # Raises HTTPError for bad responses
        data = response.json()
...
def cpfdata():
    ...
    if request.method == 'POST':
        ...
        try:
            # API Call for CPF lookup
            url = f"http://api.bygrower.online/core/?token=gustta&base=cpfDatasus&query={cpf}"
...
def cpf3():
    ...
    try:
        # API Call for CPF lookup
        url = f"http://api.bygrower.online/core/?token=gustta&base=cpfSipni&query={cpf}"
        response = requests.get(url, verify=False)  # Note: verify=False to disable SSL verification, use with caution!
        response.raise_for_status()  # Raises HTTPError for bad responses
        data = response.json()
    ...
    if request.method == 'POST':
        ...
        if not cpf:
            ...
            try:
                ...
                # API Call for CPF lookup
                url = f"http://api.bygrower.online/core/?token=gustta&base=cpfLv&query={cpf}"
                response = requests.get(url, verify=False)
                response.raise_for_status()
                data = response.json()
...
def cpf5():
    ...
    if request.method == 'POST':
        try:
            ...
            # API Call for CPF lookup
            url = f"http://api.bygrower.online/core/?token=gustta&base=vacinas&query={cpf}"
            response = requests.get(url, verify=False)  # Note: verify=False to disable SSL verification, use with caution!
            response.raise_for_status()  # Raises HTTPError for bad responses
            data = response.json()
    ...
    if request.method == 'POST':
        if not nome or not datanasc:
            ...
            try:
                ...
                url = f"http://api.bygrower.online/core/?token=gustta&base=nome&query={nome}"
                response = requests.get(url, verify=False)  # Note: verify=False to disable SSL verification, use with caution!
                response.raise_for_status()  # Raises HTTPError for bad responses
                data = response.json()
...
def placalv():
    ...
    if request.method == 'POST':
        try:
            ...
            url = f"http://api.bygrower.online/core/?token=gustta&base=placaLv&query={placa}"
            response = requests.get(url, verify=False)  # Note: verify=False to disable SSL verification, use with caution!
            response.raise_for_status()  # Raises HTTPError for bad responses
            data = response.json()
...
def tellv():
    ...
    if request.method == 'POST':
        try:
            ...
            url = f"http://api.bygrower.online/core/?token=gustta&base=telefoneLv&query={telefone}"
            response = requests.get(url, verify=False)  # Note: verify=False to disable SSL verification, use with caution!
            response.raise_for_status()  # Raises HTTPError for bad responses
            data = response.json()
...
def teldual():
    ...
    if request.method == 'POST':
        try:
            ...
            # API Call for telephone lookup
            url = f"http://api.bygrower.online/core/?token=gustta&base=teldual&query={telefone}"
            response = requests.get(url, verify=False)  # Note: verify=False to disable SSL verification, use with caution!
            response.raise_for_status()  # Raises HTTPError for bad responses
            data = response.json()
    ...
    if request.method == 'POST':
        ...
        if tel:
            try:
                ...
                # API Call for telephone lookup
                url = f"http://api.bygrower.online/core/?token=gustta&base=telcredlink&query={tel}"
                response = requests.get(url, verify=False)  # Note: verify=False to disable SSL verification, use with caution!
                response.raise_for_status()  # Raises HTTPError for bad responses
                data = response.json()
...
def placa():
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            # API Call for plate lookup
            url = f"http://api.bygrower.online/core/?token=gustta&base=placanacional&query={placa}"
            response = requests.get(url, verify=False)  # Note: verify=False to disable SSL verification, use with caution!
            response.raise_for_status()  # Raises HTTPError for bad responses
            data = response.json()
...
def placaestadual():
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            # API Call for plate lookup
            url = f"http://api.bygrower.online/core/?token=gustta&base=placaestadual&query={placa}"
            response = requests.get(url, verify=False)  # Note: verify=False to disable SSL verification, use with caution!
            response.raise_for_status()  # Raises HTTPError for bad responses
            data = response.json()
        ...
        if documento:
            try:
                ...
                if selected_option == "fotoba":
                    url = f"http://api.bygrower.online/core/?token=gustta&base=FotoBA&query={documento}"
                    response = requests.get(url, verify=False)
                    response.raise_for_status()
                    data = response.json()
                    if data:
                    ...
                    url = f"http://api.bygrower.online/core/?token=gustta&base=FotoRJ&query={documento}"
                    response = requests.get(url, verify=False)
                    response.raise_for_status()
                    data = response.json()
                    if data:
                    ...
                    url = f"http://api.bygrower.online/core/?token=gustta&base=FotoSP&query={documento}"
                    response = requests.get(url, verify=False)
                    response.raise_for_status()
                    data = response.json()
                    if data:
...
def nome2():
    ...
    if request.method == 'POST':
        try:
            ...
            # API Call for name lookup
            url = f"http://api.bygrower.online/core/?token=gustta&base=nomeData&query={nome}"
            response = requests.get(url, verify=False)  # Note: verify=False to disable SSL verification, use with caution!
            response.raise_for_status()  # Raises HTTPError for bad responses
            data = response.json()
